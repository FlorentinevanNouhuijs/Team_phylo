...
#### Wed May 15 2024, Florentine checked this code ####
...
library(ape)
text.string<- #note: output tree reads upside down
  "(
  (
  ((S, S),S)
,(((R,R),(R,R))
...
png (filename = "Output/simpletree_cluster.png", width = 50, height = 50, units='mm', res = 300) #saves to output folder
