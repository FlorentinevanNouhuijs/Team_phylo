...
cluster_df <- read.csv("Data/ClusterSizeDF_Nov2022.csv")
...
#I need column 1, 8, 20-29, 32-42 to count the percentage of drugs that is resistant 
count_data <- raw_data[, c(1, 8, 20:29, 32:42)]
#View(count_data)
count_data$Phylogroup[count_data$Phylogroup=="F"]<-"D" ###MERGE D AND F

#creating dataframe that caclculates average cluster size
...
###This code does not work on Florentine's computer > no output 
#############################
